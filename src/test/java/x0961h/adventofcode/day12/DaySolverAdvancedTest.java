...
public class DaySolverAdvancedTest {
    ...
    public void solutionTest() {
        ...
        Assert.assertEquals(5, DaySolverAdvanced.solve("[\"red\",2,3]"));
        Assert.assertEquals(4, DaySolverAdvanced.solve("[1,\"red\",3]"));
        Assert.assertEquals(10, DaySolverAdvanced.solve("[1,{\"c\":4,\"b\":2},3]"));
        ...
        Assert.assertEquals(14, DaySolverAdvanced.solve("{\"a\":[1,\"red\",5],\"b\":{\"red\":5,\"p\":3}}"));
